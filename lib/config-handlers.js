...
exports.echo = function(opts,params,cb) {
  ...
  if (payloadToSend.contents[1]) {
    payloadToSend.contents[1].text = "The Ninja Luxtronik Monitor will update every " + params.poll_interval + " seconds.";
  } else {
    payloadToSend.contents.push({ "type": "paragraph", "text": "The Luxtronik2 Monitor will update every " + params.poll_interval + " seconds."});
    payloadToSend.contents.push({ "type": "paragraph", "text": "Connecting to " + params.IP + ":" + params.Port});
